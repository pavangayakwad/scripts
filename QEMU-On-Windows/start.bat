...
qemu-system-x86_64 -hda hdd.qcow2 -m 4G -cps max -accel whpx -smp cores=4 -vnc localhost:0 -nic user,hostfwd=tcp::5555-:22,hostfwd=tcp::8080-:8080,hostfwd=tcp::3333-:3306,hostfwd=tcp::4444-:1431
